<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Estados.aspx.cs" Inherits="ClinicaWeb.Estados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        function confirmarEliminacion(rowIndex) {
            if (confirm('¿Estás seguro que deseas eliminar?')) {
                __doPostBack('<%= dgvEstados.ClientID %>', 'Eliminar$' + rowIndex);
                return true;
            }
            return false;
        }
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-4">
                <asp:TextBox ID="tbxFiltro" placeholder="Filtro estados..." CssClass="form-control" AutoPostBack="true" OnTextChanged="tbxFiltro_TextChanged" runat="server" />
            ...
            <div class="col-4 text-end">
                <a class="btn btn-secondary" href="frmEstado.aspx" role="button">Nuevo Estado</a>
            </div>
        </div>
        <br />
        <div class="row">
            <div class="col">
                <asp:GridView runat="server" ID="dgvEstados" DataKeyNames="Id" CssClass="table table-dark table-striped" AutoGenerateColumns="false" OnRowCommand="dgvEstados_RowCommand" AllowPaging="true" PageSize="6" OnPageIndexChanging="dgvEstados_PageIndexChanging">
                    <Columns>
